...
public class WxService {
	private static final String TOKEN = "156";
	private static final String APPKEY="1fec136dbd19f44743803f89bd55ca62";
	private static final String GET_TOKEN_URL="https://api.weixin.qq.com/cgi-bin/token?grant_type=client_credential&appid=APPID&secret=APPSECRET";
	//微信公众号
	private static final String APPID="wx5f02b4b91788534b";
	private static final String APPSECRET="f289e9fd74b9685f49aa6956826c294a";
	//百度AI
	...
	private static BaseMessage dealTextMessage(Map<String, String> requestMap) {
		...
		if(msg.equals("图文")) {
			...
			articles.add(new Article("这是图文消息的标题", "这是图文消息的详细介绍", "http://mmbiz.qpic.cn/mmbiz_jpg/9E0IsmNbz2hFora0MHDKibEdP9ibF7lYibl84NHf2SRHRBKaXpKyn5Rl07AN6dct4GITd9QVy9jkx78f2QScteuNg/0", "http://www.baidu.com"));
