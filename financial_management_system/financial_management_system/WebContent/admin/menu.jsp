	      ...
	      <dl class='bitem'>
	        ...
	        <dd style='display:block' class='sitem' id='items2_1'>
	          <ul class='sitemu'>
                 ...
                 <li><a href='<%=path %>/gongzi?type=lishi' target='main'>查看历史工资</a> </li>
	          </ul>
	        </dd>
	      </dl>	      
	      <%-- <dl class='bitem'>
	...
	<table width='99%' height="100%" border='0' cellspacing='0' cellpadding='0'>
	  <tr>
	    <td style='padding-left:3px;padding-top:8px' valign="top">
	      ...
	      <dl class='bitem'>
	        <dt onClick='showHide("items99_1")'><b>历史工资查看</b></dt>
	        <dd style='display:block' class='sitem' id='items99_1'>
	          <ul class='sitemu'>
                 <li><a href='<%=path %>/gongzi?type=lishi' target='main'>历史工资查看</a></li>
	          </ul>
	        </dd>
	      </dl>	      
