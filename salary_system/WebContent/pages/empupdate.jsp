...
<FORM id=form1 name=form1 action="/empUpdateServlet" method=post>
            ...
            <TD vAlign=top width="100%" bgColor=#ffffff>
                ...
                <TABLE cellSpacing=0 cellPadding=5  border=0>
                    ...
                    <TR>
                        <td>员工名称</td>
                        <td>
                            <INPUT class=textbox id=sChannel2 style="WIDTH: 180px" maxLength=50 name="ename" value="${emp.ename}">
                        </td>
                        <td>客户年龄</td>
                        <td>
                            <INPUT class=textbox id=sChannel2 style="WIDTH: 180px" maxLength=50 name="age" value="${emp.age}">
                        </td>
                    </TR>
                    ...
                    <TR>
                        ...
                        <td>员工工资</td>
                        <td>
                            <INPUT class=textbox id=sChannel2 style="WIDTH: 180px" maxLength=50 name="sal" value="${emp.sal}">
                        </td>
                    </TR>
                    ...
                    <TR>
                        <td>员工生日</td>
                        <td>
                            <INPUT class=textbox id=sChannel2 style="WIDTH: 180px" maxLength=50 name="birthday" onclick="WdatePicker()" readonly value="${emp.birthday}">
                        </td>
                        <td>入职日期</td>
                        <td>
                            <INPUT class=textbox id=sChannel2 style="WIDTH: 180px" maxLength=50 name="edate" onclick="WdatePicker()" readonly value="${emp.edate}">
                        </td>
                    </TR>
